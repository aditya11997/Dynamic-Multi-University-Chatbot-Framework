...
const formatText = (text) => {
  ...
  return (
    <div className="chat-container">
      ...
      <p className="disclaimer">PaceBot can generate inaccurate answers. Check important info.</p>
    </div>
  );
};
